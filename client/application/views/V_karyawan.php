	...
	<div class="container">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Data <b>Motor</b></h2>
					</div>
					<div class="">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"> <span>Tambah Motor</span></a>
					</div>
					</br>
					<div class="">
						<a href="<?php echo site_url('C_karyawan/getCicil');?>" class="btn btn-success" data-toggle="modal"> <span>Tenor</span></a>
					</div>
					</br>
					<div class="">
						<a href="<?php echo site_url('C_karyawan/getuangMuka');?>" class="btn btn-success" data-toggle="modal"> <span>Uang Muka</span></a>
					</div>
					</br>
					<div class="">
						<a href="<?php echo site_url('C_karyawan/getPenjualan');?>" class="btn btn-success" data-toggle="modal"> <span>Penjualan</span></a>
					</div>
					</br>
				</div>
			</div>
